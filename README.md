...
You can download the demo project from this **Github Page**. If you want to have a better reading experience, please check our [Gitbook Version](http://dji-dev.gitbooks.io/mobile-sdk-tutorials/content/en/Android/PlaybackAlbumDemo/Playback_Demo_Android_en.html)
...
![Multiple playback view](./Images/gridview.jpg)
...
![Capture Mode](./Images/capturemode.jpg)

![Record Mode](./Images/recordmode.jpg)

![Single Playback Mode](./Images/singleplayback.jpg)

![Multiple Playback Mode](./Images/multipleplayback.jpg)

![State switch figure](./Images/statuschange.jpg)
...
![Single swipee gesture](./Images/singleslide.png)

![Multiple swipe gesture](./Images/multipleslide.jpg)
...
![Play the video](./Images/playbutton.jpg)

![Pause the video](./Images/pausebutton.jpg)
...
![Multiple Select](./Images/multipleselect.jpg)

![Downloading](./Images/download.jpg)

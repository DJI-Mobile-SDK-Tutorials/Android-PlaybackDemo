...
public class ConnectionActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filter.addAction(PlaybackDemoApplication.FLAG_CONNECTION_CHANGE);
    ...
    private void updateVersion() {
        String version = null;
        if(PlaybackDemoApplication.getProductInstance() != null) {
            version = PlaybackDemoApplication.getProductInstance().getFirmwarePackageVersion();
        }
